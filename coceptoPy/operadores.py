...
resto = a % b # Resto de la división (lo que sobra)
exponenciacion = a ** b # a elevado a b

## Operadores de asignación

x = 10 # = El es el operador de asignación más básico
x += 3 # += le suma el valor al valor anterior
x -= 2 # -= le resta el valor al valor anterior
x *= 2 # *= le multiplica el valor al valor anterior
x /= 2 # /= le divide el valor al valor anterior
x = 1
x **= 2
